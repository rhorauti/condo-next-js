...
import { AddressFormDialogLoading } from './address-form-dialog-loading';
  ...
  return (
    <Dialog open={isActive} onOpenChange={(open) => !open && onCloseDialog()}>
      <DialogContent
        ...
        className="sm:max-w-[60rem] max-h-screen flex flex-col"
      >
        {isLoadingAddress ? (
          <AddressFormDialogLoading />
        ) : (
          <>
            ...
            <form
              ...
              className="flex flex-col gap-2 max-h-[40rem] overflow-y-auto"
            >
