...
export default function Post({ user, onCommentButtonClick }: IProps) {
  ...
  return (
    <article className="flex flex-col items-center gap-2 max-w-[30rem] justify-start border border-gray-400 rounded-md p-4">
      ...
      <section className="p-1">
        <Carousel setApi={setApi} className="max-w-[27rem]">
          <CarouselContent>
            {Array.from(mediaList || []).map((media, index) => (
      ...
      <footer>
        ...
        >
          ...
          >
            <Button variant="ghost" className={cn('flex justify-center')}>
              <HeartIcon />
